...
execute if score enabled gui matches 0 run data modify storage practice:recipes chestB append value {id:"minecraft:gray_dye",Count:1b,tag:{display:{Name:'{"text":"Disabled","italic":"false","color":"red"}'}}}
execute if score enabled gui matches 1 run data modify storage practice:recipes chestB append value {id:"minecraft:lime_dye",Count:1b,tag:{display:{Name:'{"text":"Enabled","italic":"false","color":"green"}'}}}

scoreboard players remove column gui 1
execute store result storage practice:recipes chestB[-1].Slot byte 1 run scoreboard players get slot gui
execute store result storage practice:recipes chestB[-1].tag.index byte 1 run scoreboard players get column gui
...
# append goals_temp to chestA
data modify storage practice:recipes chestA append from storage practice:recipes goals_temp[0]
data modify storage practice:recipes chestA append from storage practice:recipes goals_temp[1]
data modify storage practice:recipes chestA append from storage practice:recipes goals_temp[2]
