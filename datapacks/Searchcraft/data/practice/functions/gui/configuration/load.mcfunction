...
data modify block 0 61 -2 Items prepend from storage practice:gui background_config[]
data modify block 0 61 -3 Items set from storage practice:recipes recipes[{selected:1b}].resources
